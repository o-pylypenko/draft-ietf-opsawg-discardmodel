...
9. When there are multiple reasons for discarding a packet, the ordering of discard class reporting MUST be unambiguously characterized. Implementations SHOULD expose this ordering by means of `discard-order-capability` and MAY use another mechanism (e.g., due to implementation constraints), provided the ordering is documented.
